...
void StandaloneTrackMonitor::bookHistograms(DQMStore::IBooker &iBook, edm::Run const& iRun, edm::EventSetup const& iSetup) {
  ...
  if (haveAllHistograms_) {
    ...
    DistanceOfClosestApproachToPVVsPhiH_ = iBook.bookProfile("DistanceOfClosestApproachToPVVsPhi", "DistanceOfClosestApproachToPVVsPhi",70,-3.5,3.5,1.0e-03,1.0e+03,"g");
    xPointOfClosestApproachVsZ0wrtPVH_ = iBook.bookProfile("xPointOfClosestApproachVsZ0wrtPV", "xPointOfClosestApproachVsZ0wrtPV",120,-60,60,-0.07,0.07,"g");
    yPointOfClosestApproachVsZ0wrtPVH_ = iBook.bookProfile("yPointOfClosestApproachVsZ0wrtPV", "yPointOfClosestApproachVsZ0wrtPV",120,-60,60,-0.08,0.08,"g");
    ...
    nvalidPixelEHitsH_ = iBook.book1D("nvalidPixelEndcapHits", "No. of Valid Hits in Pixel Endcap",6,-0.5,5.5);
    ...
    nlostPixelBHitsH_ = iBook.book1D("nlostPixelBarrelHits", "No. of Lost Hits in Pixel Barrel",6,-0.5,5.5);
    nlostPixelEHitsH_ = iBook.book1D("nlostPixelEndcapHits", "No. of Lost Hits in Pixel Endcap",6,-0.5,5.5);
